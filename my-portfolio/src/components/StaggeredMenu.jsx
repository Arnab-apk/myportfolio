...
.sm-scope .sm-panel-item { position: relative; color: #000; font-weight: 600; font-size: 4rem; cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform: uppercase; transition: all 0.3s ease; display: inline-block; text-decoration: none; padding-right: 1.4em; opacity: 1; }
.sm-scope .sm-panel-list:hover .sm-panel-item:not(:hover) { opacity: 0.4; }
.sm-scope .sm-panel-list:focus-within .sm-panel-item:not(:focus-visible) { opacity: 0.4; }
.sm-scope .sm-panel-itemLabel { display: inline-block; will-change: transform; transform-origin: 50% 100%; transition: transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1); }
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #ff0000); opacity: 1; }
.sm-scope .sm-panel-item:hover .sm-panel-itemLabel { transform: scale(1.05); }
