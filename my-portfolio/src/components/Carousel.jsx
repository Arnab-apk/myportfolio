...
export default function Carousel({
    ...
    return (
        <div
            ref={containerRef}
            className={`relative overflow-hidden p-4 ${round ? 'rounded-full border border-white/20' : 'rounded-[24px] border border-white/10'
                }`}
            style={{
                width: `${baseWidth}px`,
                    ...
                    return (
                        ...
                        >
                            <div className={`${round ? 'p-0 m-0' : 'mb-4 p-5'}`}>
                                <span className="flex h-[28px] w-[28px] items-center justify-center rounded-full bg-brand-yellow/20">
                                    {item.icon}
                                </span>
                            </div>
                            <div className="p-5">
