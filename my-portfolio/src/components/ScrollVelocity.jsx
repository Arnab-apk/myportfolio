...
export const ScrollVelocity = ({
  ...
  parallaxStyle = {},
  scrollerStyle = {},
  variant = 'gradient' // 'gradient', 'outline', 'glow', 'minimal'
}) => {
  function VelocityText({
    ...
    return (
      ...
      >
        <motion.div
          className={`${scrollerClassName} flex whitespace-nowrap text-center font-sans text-4xl font-bold tracking-[-0.02em] drop-shadow-lg md:text-[5rem] md:leading-[5rem]`}
  ...
  const selectedVariant = variantStyles[variant] || variantStyles.gradient;
    ...
    <section className="relative py-8 sm:py-12 md:py-16">
      ...
      <div className="relative space-y-4 sm:space-y-6">
        {texts.map((text, index) => (
          <VelocityText
            key={index}
            className={`${className} ${selectedVariant} transition-all duration-300 hover:scale-105 cursor-default`}
            ...
            parallaxClassName={`${parallaxClassName} py-2 sm:py-3 backdrop-blur-sm`}
